...
whycode::Parameters CWhycodeROSNode::process_lib_parameters() {
  ...
  why_params.field_length = this->declare_parameter("field_length", why_params.field_length);
  why_params.field_width = this->declare_parameter("field_width", why_params.field_width);
